...
const SettingsMenu = ({TIME_INTERVAL, SPAWN_INTERVAL, lives, dispatch}) => (
    ...
    >
        ...
        <div style={{marginBottom: '10px'}}>
            ...
            <input style={{width:'50px'}} id="timeIntervalInput" type="number" min={0.01} max={10} onInput={handleTimeIntervalChange.bind(this, {dispatch: dispatch})} defaultValue={TIME_INTERVAL/1000}/>
            <label> seconds.</label>
        </div>
        <div style={{marginBottom: '10px'}}>
            <label htmlFor="spawnIntervalInput">Spawn Interval : </label>
            <input style={{width:'50px'}} id="spawnIntervalInput" type="number" min={0.01} max={10} onInput={handleSpawnIntervalChange.bind(this, {dispatch: dispatch})} defaultValue={SPAWN_INTERVAL/1000}/>
            <label> seconds.</label>
        </div>
